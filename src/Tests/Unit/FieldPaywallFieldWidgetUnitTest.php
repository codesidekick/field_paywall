...
class FieldPaywallFieldWidgetUnitTest extends FieldPaywallUnitTestBase {
  ...
  /**
   * Test the formElement method.
   *
   * @covers ::formElement
   */
  public function testFormElement() {
    $entity = $this->createTestEntity(TRUE);
    $paywall_widget = $this->getFieldWidgetFromEntity($entity);
    ...
    $form_element_output = $paywall_widget->formElement($items, $delta, $element, $form, $form_state);
    ...
    $form_element_output_disabled = $paywall_widget->formElement($disabled_items, $delta, $element, $form, $form_state);
    ...
    // Test both scenarios in which the value is checked and not checked.
